...
def run():
    slopes_df = pd.read_csv("supply_slopes.csv")
    thresholds_df = pd.read_csv("supply_thresholds.csv")
    try:
        _validate_slopes(slopes_df, "supply_slopes.csv")
        _validate_thresholds(thresholds_df, "supply_thresholds.csv")
